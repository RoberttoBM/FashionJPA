...
import com.demo.fashion.controller.ClienteFacade;
...
public class ClienteController implements Serializable {
    ...
    @EJB
    private com.demo.fashion.controller.ClienteFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Vistas").getString("ClienteCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Vistas").getString("ClienteUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Vistas").getString("ClienteDeleted"));
        if (!JsfUtil.isValidationFailed()) {
